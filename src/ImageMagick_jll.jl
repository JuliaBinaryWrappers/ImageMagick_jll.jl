...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import ImageMagick_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c73af94c-d91f-53ed-93a7-00f77d67a9d7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "ImageMagick", artifacts_toml) for e in artifacts["ImageMagick"]]
...
if best_platform === nothing
    @debug("Unable to load ImageMagick; unsupported platform $(triplet(platform_key_abi()))")
else
